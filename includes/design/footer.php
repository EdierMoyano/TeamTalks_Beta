    ...
    <div class="container text-center text-md-start">
        <div class="row text-center text-md-start">
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <hr class="text-white mb-4">
                <p>
                    <a href="soporte.php" class="text-white" style="text-decoration:none">Contacta Soporte Tecnico</a>
                </p>
            </div>
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                ...
                <hr class="text-white mb-4">
                <p>
                    <a href="reportes.php" class="text-white" style="text-decoration:none">Contacta Realizar Reportes</a>
                </p>
