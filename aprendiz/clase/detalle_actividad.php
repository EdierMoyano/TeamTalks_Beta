...
$materiaPrincipal = $materiaPrincipalData['materia'] ?? 'Sin materia asignada';
...
<body class="sidebar-collapsed">
    ...
    <main class="main-content">
        <div class="container-fluid"
            ...
            <div class="actividad-header">
                ...
                <div class="actividad-meta">
                    <div class="meta-item">
                        ...
                        <span><?php echo htmlspecialchars($materiaPrincipal); ?></span>
                    </div>
                    <div class="meta-item">
            ...
            <?php
            $archivosInstructor = [
                $actividad['archivo1'] ?? null,
                $actividad['archivo2'] ?? null,
                $actividad['archivo3'] ?? null
            ];
            ...
            <?php if ($tieneArchivosInstructor): ?>
                <div class="archivos-instructor-section-compact">
                    ...
                    <div class="archivos-instructor-list">
                        <?php foreach ($archivosInstructor as $archivo): ?>
                            <?php if (!empty($archivo) && file_exists("../../uploads/" . $archivo)): ?>
                                ...
                                <div class="archivo-instructor-compact">
                                    <div class="archivo-icon-compact"><i class="<?php echo $iconClass; ?>"></i></div>
                                    ...
                                    <div class="archivo-acciones-compact">
                                        <a href="<?php echo $rutaCompleta; ?>" class="btn-compact btn-ver" target="_blank"><i class="fas fa-eye"></i></a>
                                        <a href="<?php echo $rutaCompleta; ?>" class="btn-compact btn-descargar" download><i class="fas fa-download"></i></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        <?php endforeach; ?>
            ...
            <?php if (
                $entregaExistente &&
                (
                    !empty($entregaExistente['contenido']) ||
                    !empty($entregaExistente['archivo1']) ||
                    !empty($entregaExistente['archivo2']) ||
                    !empty($entregaExistente['archivo3']) ||
                    !empty($entregaExistente['fecha_entrega'])
                )
            ): ?>
