...
try {
    ...
    // Total de licencias activas (id_estado = 1)
    $stmt = $conn->query("SELECT COUNT(*) as total FROM licencias WHERE id_estado = 1");
    $total_licencias_activas = $stmt->fetch(PDO::FETCH_ASSOC)['total'] ?? 0;

    // Total de licencias expiradas (id_estado = 2)
    $stmt = $conn->query("SELECT COUNT(*) as total FROM licencias WHERE id_estado = 2");
    ...
    // Licencias próximas a expirar (30 días, activas)
    $stmt = $conn->query("
    ...
    $stmt = $conn->query("
        SELECT l.id_licencia, l.fecha_ini, l.fecha_fin, l.id_estado, 
            ...
            <div class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item"><a class="nav-link" href="empresas_crear.php"><i class="bi bi-building-add"></i> Nueva Empresa</a></li>
                        <li class="nav-item"><a class="nav-link" href="licencias_crear.php"><i class="bi bi-key-fill"></i> Nueva Licencia</a></li>
                        <li class="nav-item"><a class="nav-link" href="usuarios_crear.php"><i class="bi bi-person-plus"></i> Nuevo Usuario</a></li>
                    </ul>
                </div>
            </div>
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-primary bg-gradient text-white shadow card-dashboard h-100 py-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs text-uppercase mb-1">Empresas</div>
                                    <div class="h5 mb-0"><?php echo $total_empresas; ?></div>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-success bg-gradient text-white shadow card-dashboard h-100 py-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs text-uppercase mb-1">Licencias Activas</div>
                                    <div class="h5 mb-0"><?php echo $total_licencias_activas; ?></div>
                                </div>
                                <i class="bi bi-key fs-2"></i>
                            </div>
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                <a class="small text-white stretched-link" href="licencias.php?id_estado=1">Ver Detalles</a>
                                <i class="bi bi-chevron-right small text-white"></i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-warning bg-gradient text-white shadow card-dashboard h-100 py-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs text-uppercase mb-1">Por Expirar</div>
                                    <div class="h5 mb-0"><?php echo $licencias_por_expirar; ?></div>
                                </div>
                    ...
                    <div class="col-xl-3 col-md-6 mb-4">
                        <div class="card bg-danger bg-gradient text-white shadow card-dashboard h-100 py-2">
                            <div class="card-body d-flex justify-content-between align-items-center">
                                <div>
                                    <div class="text-xs text-uppercase mb-1">Licencias Expiradas</div>
                                    <div class="h5 mb-0"><?php echo $total_licencias_expiradas; ?></div>
                                </div>
                                <i class="bi bi-x-circle fs-2"></i>
                            </div>
                            <div class="card-footer d-flex justify-content-between align-items-center">
                                <a class="small text-white stretched-link" href="licencias.php?id_estado=2">Ver Detalles</a>
                                <i class="bi bi-chevron-right small text-white"></i>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Últimas licencias y empresas -->
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card mb-4">
                            <div class="card-header"><i class="bi bi-table me-1"></i> Últimas Licencias Asignadas</div>
                            <div class="card-body table-responsive">
                                <table class="table table-striped table-sm">
                                    <thead>
                                        <tr><th>ID</th><th>Empresa</th><th>Tipo</th><th>Inicio</th><th>Fin</th><th>Estado</th></tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php elseif ($licencia['id_estado'] == 2): ?>
                    ...
                    <div class="col-lg-6">
                        <div class="card mb-4">
                            <div class="card-header"><i class="bi bi-building me-1"></i> Últimas Empresas Registradas</div>
                            <div class="card-body table-responsive">
                                <table class="table table-striped table-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="empresas_ver.php?id=<?php echo $empresa['nit']; ?>" class="btn btn-sm btn-info"><i class="bi bi-eye"></i></a>
                                                <a href="empresas_editar.php?id=<?php echo $empresa['nit']; ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>
                                            </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4 mb-3"><a href="empresas_crear.php" class="btn btn-primary w-100 py-3"><i class="bi bi-building-add me-2"></i> Registrar Nueva Empresa</a></div>
                                    <div class="col-md-4 mb-3"><a href="licencias_crear.php" class="btn btn-success w-100 py-3"><i class="bi bi-key-fill me-2"></i> Asignar Nueva Licencia</a></div>
                                    <div class="col-md-4 mb-3"><a href="usuarios_crear.php" class="btn btn-info w-100 py-3"><i class="bi bi-person-plus-fill me-2"></i> Registrar Nuevo Usuario</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
